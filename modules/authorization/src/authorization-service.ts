...
const capabilities: Readonly<Record<RoleCode, readonly string[]>> = {
  COL: ["resource.view", "resource.create", "resource.edit"],
  AGT: ["resource.view", "resource.create", "resource.edit"],
  SAG: ["resource.view", "resource.create", "resource.edit", "proposal.approve"],
  REV: ["resource.view"],
  AIR: ["resource.view", "ai.review"],
  ...
  DST: ["resource.view", "resource.create", "resource.edit"],
  OPS: ["resource.view", "publication.deliver", "resource.export"],
  SEC: ["audit.query", "audit.export", "security.admin", "resource.view"],
  ADM: [
    "admin.role.propose",
    "admin.role.approve",
    "admin.role.revoke",
  ...
  SVC: ["service.execute", "publication.deliver"],
  EXT: [],
};
