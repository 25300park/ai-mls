...
const capabilities: Readonly<Record<RoleCode, readonly string[]>> = {
  ...
  REV: ["resource.view"],
  AIR: ["resource.view", "ai.result.read", "ai.review", "intake.read", "requirement.read"],
  ...
  MGR: ["resource.view", "audit.query", "client.read"],
  DST: [
    "resource.view",
    "resource.create",
    "resource.edit",
  ...
  SEC: ["audit.query", "audit.export", "security.admin", "resource.view", "source.read", "contact.read", "contact.reveal", "client.read"],
  ADM: [
    "admin.role.propose",
    "admin.role.approve",
    "admin.role.revoke",
