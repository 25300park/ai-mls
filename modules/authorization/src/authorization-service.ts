...
const capabilities: Readonly<Record<RoleCode, readonly string[]>> = {
  ...
  REV: ["resource.view", "matching.read", "matching.review", "verification.read", "verification.review", "permission.read", "permission.support"],
  ...
  PMR: ["resource.view", "permission.approve", "permission.request", "permission.read", "permission.review", "permission.decide", "permission.revoke", "contact.read"],
  PUA: ["resource.view", "publication.approve", "permission.read"],
  MGR: ["resource.view", "audit.query", "client.read", "matching.read", "permission.read", "permission.override", "verification.request", "verification.read", "verification.assign", "verification.perform", "verification.override"],
  DST: [
    "resource.view",
    "resource.create",
    "resource.edit",
  ...
  SEC: ["audit.query", "audit.export", "security.admin", "resource.view", "source.read", "permission.read", "contact.read", "contact.reveal", "client.read"],
  ADM: [
    "admin.role.propose",
    "admin.role.approve",
    "admin.role.revoke",
