...
export type CoordinatePublicationReconciliationInterfaceRequest = PublicationReconciliationRequest & {
  readonly operation: "COORDINATE_PUBLICATION_RECONCILIATION";
};
