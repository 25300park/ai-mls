...
export const PUBLICATION_EVENT_SCHEMA_VERSION = "v1" as const;
export const PUBLICATION_EVENT_CONTRACT_VERSION = "v1" as const;
...
export interface CreatePublicationEventEnvelopeInput extends Omit<PublicationEventEnvelope, "eventId" | "eventSchemaVersion" | "eventContractVersion" | "aggregateType" | "integrity"> {
...
export function validatePublicationEventEnvelope(event: PublicationEventEnvelope): void {
  ...
  const allowed = new Set([...required, "attemptId"]);
