# Decision Dependency Matrix — AO-023–AO-035
...
DEC-100–DEC-112의 선행·후속 관계와 scoped refinement를 정의하고 순환 의존성이 없는지 검증한다. Decision의 status와 내용은 [Decision Register](00_DECISION_REGISTER.md)가 authoritative source다.
...
- Decision nodes: 13 aligned nodes plus 4 existing prerequisite nodes
