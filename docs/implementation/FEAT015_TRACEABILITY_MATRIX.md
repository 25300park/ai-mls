...
| `F15-TASK-008~009` reconciliation / API-014·UI | canonical use-case 및 contract implementation evidence 없음 | F15-TASK-007은 post-publication lifecycle coordination만 구현하며 후속 Task 범위를 시작하지 않음 | PENDING |
