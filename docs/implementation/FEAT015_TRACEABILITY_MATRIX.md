...
| `F15-TASK-009` API-014 and UI view contracts | canonical use-case 및 contract implementation evidence 없음 | F15-TASK-008은 reconciliation/recovery coordination만 구현하며 API-014/UI 범위를 시작하지 않음 | PENDING |
