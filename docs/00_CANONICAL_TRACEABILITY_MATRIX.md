...
| TRACE-013 | REQ-CONST-002–004, REQ-CONST-010, REQ-CONST-013 | WF-007–011 | Permission, Approval History, Contact Channel | API-012 | UI-026, UI-028–032 | AI-007 — evidence support only; no approval authority | DEV-013 | SP-006 | REL-002 | TEST-003, TEST-012, TEST-020–022, TEST-024, TEST-032 | VERIFIED |
| TRACE-014 | REQ-CONST-002–004, REQ-CONST-010, REQ-CONST-013 | WF-008, WF-009 | Client Proposal, Publication Approval, Verification, Permission | API-013 | UI-025, UI-028–030 | N/A — human approval is mandatory | DEV-014 | SP-007 | REL-002 | TEST-021, TEST-022, TEST-033 | VERIFIED |
| TRACE-015 | REQ-CONST-002–007, REQ-CONST-009, REQ-CONST-012, REQ-CONST-013 | WF-009–012 | Publication, Publication Target, Status History, System Error | API-014 | UI-029–033, UI-035 | N/A — publication authority is deterministic and human-approved | DEV-015 | SP-007 | REL-002 | TEST-002–004, TEST-008, TEST-011, TEST-012, TEST-022–025, TEST-033, TEST-049 | VERIFIED |
