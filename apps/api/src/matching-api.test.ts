...
test("SP-005 composition adds API-010 without replacing SP-001–004 modules", () => {
  const composed = composeApiModules({ sessionService: { readSession: () => actor }, matchingService: dependencies([]).matchingService, matchingInputResolver: dependencies([]).matchingInputResolver, authorizationService: {}, administrationService: {}, auditLog: {}, sourceRegistryService: {}, intakeService: {}, jobService: {}, propertyService: {}, listingService: {}, contactService: {}, clientRequirementService: {} } as unknown as ApiModuleDependencies);
